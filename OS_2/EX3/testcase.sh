...
./atom_supplier 127.0.0.1 $TCP_PORT <<EOF
ADD HYDROGEN 100
ADD OXYGEN 100
ADD CARBON 100
EOF
...
./molecule_requester 127.0.0.1 $UDP_PORT <<EOF
DELIVER WATER 3
...
./drinks_bar 7771 2221 &
(
echo "ADD OXYGEN 10"
sleep 5
echo "EXIT"
) | ./atom_supplier 127.0.0.1 7771 &

CLIENT1_PID=$!
sleep 1 


./atom_supplier 127.0.0.1 7771 <<EOF
SHUTDOWN
EOF
...
./drinks_bar 1987 8787 &



echo "🧪 Test 10.a: ADD valid atoms (TCP)"
./atom_supplier 127.0.0.1 1987 <<EOF
ADD HYDROGEN 100
ADD OXYGEN 100
ADD CARBON 100
EOF
...
./molecule_requester 127.0.0.1 8787 <<EOF
DELIVER CARBON DIOXIDE 2
